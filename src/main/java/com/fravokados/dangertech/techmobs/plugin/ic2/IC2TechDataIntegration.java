...
public class IC2TechDataIntegration {
	...
	public static void loadTileEntityValues() {
		...
		try {
			...
			LogHelperTM.warn(e, "IC2Integration: Could not load TileEntityGenerator!");
		}
		...
		try {
			...
			LogHelperTM.warn(e, "IC2Integration: Could not load TileEntitySolarGenerator!");
		}
		...
		try {
			...
			LogHelperTM.warn(e, "IC2Integration: Could not load TileEntityGeoGenerator!");
		}
		...
		try {
			...
			LogHelperTM.warn(e, "IC2Integration: Could not load TileEntityRTGenerator!");
		}
		...
		try {
			...
			LogHelperTM.warn(e, "IC2Integration: Could not load TileEntityWindGenerator!");
		}
		...
		try {
			...
			LogHelperTM.warn(e, "IC2Integration: Could not load TileEntityWaterGenerator!");
		}
		...
		try {
			...
			LogHelperTM.warn(e, "IC2Integration: Could not load TileEntityKineticGenerator!");
		}
		...
		try {
			...
			LogHelperTM.warn(e, "IC2Integration: Could not load TileEntitySemiFluidGenerator!");
		}
		...
		try {
			...
			LogHelperTM.warn(e, "IC2Integration: Could not load TileEntityStirlingGenerator!");
		}
