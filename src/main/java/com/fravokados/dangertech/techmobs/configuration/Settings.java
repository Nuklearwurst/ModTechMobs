...
public class Settings {
	...
	public static class TechData {
		...
		/**
		 * 1 out of n<br>
		 * chance that a td effect is applied to a player (checked every {@link com.fravokados.dangertech.techmobs.configuration.Settings.TechData#TD_RANDOM_TICKS} (1200) ticks)
		 */
		public static int TD_RANDOM_PLAYER_EVENT_CHANCE = 10;
		
		/**
		 * 1 out of n<br>
		 * chance that a td effect is applied to a chunk (checked every {@link com.fravokados.dangertech.techmobs.configuration.Settings.TechData#TD_RANDOM_TICKS} (1200) ticks)
		 */
